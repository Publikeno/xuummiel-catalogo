...
const products: Product[] = [
  ...
  },
  {
    ...
    benefits: [
      ...
      "Presentación llamativa para visitantes y coleccionistas",
    ],
    page: 17,
    image: catalogPages.p17,
    imageAlt:
      "Presentación grande de miel melipona en estuche de madera pirámide.",
    imageCaption:
      "Referencia visual del estuche pirámide · presentación de 600 ml",
  },
  {
    id: "jabon-coco-arroz",
  ...
  },
  {
    ...
    price: "$170",
    priceDetails:
      "Estuche vacío $170 · kit con 1 jabón y 1 gotero de miel Melipona de 10 ml $370",
    size: "20 cm ancho × 15 cm fondo × 9 cm alto",
    ingredient: "Madera recuperada de cedro · logotipo · grabado",
    description:
      "Estuche de madera recuperada de cedro con logotipo y posibilidad de grabar nombres de puntos turísticos de Quintana Roo, como Leona Vicario, Puerto Morelos, Cancún, Playa del Carmen, Cozumel o Tulum.",
    benefits: [
      "Empaque reutilizable con identidad regional",
      "Personalizable para bodas, eventos y regalos corporativos",
      "Puede combinarse con un jabón y un gotero de miel Melipona",
    ],
    page: 5,
    image: catalogPages.p05,
    imageAlt:
      "Estuche artesanal de madera para productos de miel y cuidado personal.",
    imageCaption:
      "Referencia visual de estuche artesanal · medidas comunicadas por la tienda",
  },
  {
    id: "crema-chrc-m",
  ...
  },
  {
    ...
    benefits: [
      "Acompaña la sensación de firmeza y cuidado de la piel",
      "Combina el perfil botánico del romero con vitamina E",
  ...
  },
  {
    ...
    description:
      "Propóleo con eucalipto de las hojas en envase con atomizador de 25 ml, una presentación práctica de perfil herbal.",
    benefits: [
      "Aroma fresco y herbal de eucalipto",
      "Formato atomizador fácil de llevar",
      "Producto de la colmena para una línea de bienestar tradicional",
    ],
    page: 20,
    image: GALLERY_URLS.img8163,
    imageAlt: "Propóleo con eucalipto en envase con atomizador.",
    imageCaption:
      "Foto de producto · propóleo con eucalipto · presentación de 25 ml",
    isProductPhoto: true,
  },
  {
    id: "hidromiel-360",
    ...
    ingredient: "Miel fermentada · fórmula artesanal",
    description:
      "Hidromiel en botella oscura de 360 ml con envase tipo cerveza, pensada para degustación y regalo.",
    benefits: [
      "Presentación lista para servir",
      "Envase oscuro con estética artesanal",
      "Producto distintivo para experiencias gastronómicas",
    ],
    page: null,
  ...
  },
  {
    ...
    description:
      "Miel Apis, la miel regular, en botella de cristal nueva con contenido de 750 gramos.",
    benefits: [
      "Sabor tradicional de la miel Apis",
      "Cristal nuevo para una presentación limpia",
  ...
  },
  {
    ...
    ingredient: "Miel Apis",
    description:
      "Miel Apis en botella de cristal nueva con contenido de un kilogramo para consumo familiar o reventa.",
    benefits: [
      "Presentación de mayor rendimiento",
      "Sabor tradicional de la miel regular",
      "Envase nuevo y listo para exhibición",
    ],
    page: null,
    image: HONEY_URL,
    imageAlt: "Botella de miel Apis.",
    imageCaption: "Foto de referencia de miel Apis · botella nueva de 1 kg",
  },
  {
    ...
    description:
      "Miel Apis en botella reciclada de vino, una presentación artesanal que da una segunda vida al vidrio.",
    benefits: [
      "Reutilización de envases de vidrio",
      "Presentación artesanal y distintiva",
  ...
  },
  {
    ...
    ingredient: "Miel Apis · vidrio reciclado",
    description:
      "Miel Apis en botella reciclada de vino con contenido de 700 gramos, pensada para una presentación sostenible.",
    benefits: [
      "Aprovechamiento de vidrio reciclado",
      "Diseño con personalidad para anaquel",
  ...
  },
  {
    ...
    ingredient: "Miel Apis · vidrio reciclado",
    description:
      "Miel Apis en botella reciclada de vino con presentación de un kilogramo y carácter artesanal.",
    benefits: [
      "Mayor contenido en un envase reutilizado",
      "Presentación artesanal para venta o regalo",
  ...
  },
  {
    ...
    ingredient: "Miel Apis · vidrio reciclado",
    description:
      "La presentación de mayor contenido de la línea de Miel Apis en botella reciclada de vino.",
    benefits: [
      "Formato familiar de alto contenido",
      "Envase reutilizado con identidad artesanal",
  ...
  },
  {
    ...
    ingredient: "Ixtle",
    description:
      "Estropajo de ixtle de fibra natural para complementar rutinas de baño y cuidado personal.",
    benefits: [
      "Fibra de origen natural",
      "Accesorio práctico para la rutina de baño",
      "Complemento ideal para jabones artesanales",
    ],
    page: null,
    image: INGREDIENTS_URL,
    imageAlt: "Materiales naturales de la colección artesanal.",
    imageCaption:
      "Imagen de referencia · estropajo de ixtle · precio por pieza",
  },
  {
    id: "estropajo-arbol",
    ...
    description:
      "Estropajo de árbol con diseño colgante y orilla de tela, pensado para acompañar jabones y productos de cuidado personal.",
    benefits: [
      "Diseño colgante para facilitar el almacenamiento",
      "Complemento artesanal para el baño",
      "Puede combinarse con jabones y kits de regalo",
    ],
    page: null,
    image: INGREDIENTS_URL,
    imageAlt: "Materiales naturales de la colección artesanal.",
...
const catalogPhotos: CatalogPhoto[] = [
  {
    ...
    note: "Producto identificado",
  },
  {
    id: "img-8092",
    name: "Jabón de panal y abeja",
    category: "Jabones artesanales",
    image: GALLERY_URLS.img8092,
    alt: "Jabón artesanal con relieve de panal y abeja",
    note: "Diseño recibido",
  },
  {
    id: "img-8094",
    name: "Jabón artesanal rosa",
    category: "Jabones artesanales",
    image: GALLERY_URLS.img8094,
    alt: "Jabón artesanal rosa con relieve de panal",
    note: "Variante por confirmar",
  },
  {
    id: "img-8097",
    ...
    category: "Jabones artesanales",
    image: GALLERY_URLS.img8097,
    alt: "Jabón artesanal rosa de fresa champagne",
    note: "Producto identificado",
  },
  {
    id: "img-8103",
    ...
    category: "Jabones artesanales",
    image: GALLERY_URLS.img8103,
    alt: "Jabón oscuro de tepezcohuite",
    note: "Producto identificado",
  },
  {
    id: "img-8105",
    name: "Jabón de tepezcohuite · vista alternativa",
    category: "Jabones artesanales",
    image: GALLERY_URLS.img8105,
    alt: "Vista alternativa del jabón de tepezcohuite",
    note: "Vista complementaria",
  },
  {
    id: "img-8111",
    name: "Jabón azul",
    ...
    note: "Fórmula por identificar",
  },
  {
    id: "img-8115",
    name: "Jabón de lavanda y miel",
    category: "Jabones artesanales",
    image: GALLERY_URLS.img8115,
  ...
  },
  {
    ...
    name: "Kit caja flor",
    category: "Kits y regalos",
    image: GALLERY_URLS.img8116,
    alt: "Caja de regalo con jabón en forma de flor y frasco con gotero",
    note: "Contenido por confirmar",
  },
  {
    id: "img-8134",
    ...
    alt: "Frasco con gotero del elixir de miel y cacao",
    note: "Producto identificado",
  },
  {
    id: "img-8136",
    name: "Repelente de neem",
    category: "Protección natural",
    image: GALLERY_URLS.img8136,
    alt: "Repelente de neem en atomizador",
    note: "Producto nuevo",
  },
  {
    id: "img-8139",
    name: "Crema RCH · vista lateral",
    category: "Cuidado facial y corporal",
    image: GALLERY_URLS.img8139,
    alt: "Crema RCH en envase con bomba",
    note: "Vista complementaria",
  },
  {
    id: "img-8141",
    ...
    category: "Cuidado facial y corporal",
    image: GALLERY_URLS.img8141,
    alt: "Crema regeneradora RCH en envase con bomba",
    note: "Producto identificado",
  },
  {
    id: "img-8149",
    name: "Dúo de jabones",
    category: "Kits y regalos",
    image: GALLERY_URLS.img8149,
    alt: "Composición de dos jabones artesanales",
    note: "Composición por confirmar",
  },
  {
    id: "img-8158",
    name: "Shampoo preventivo de miel, romero y neem",
    category: "Cuidado capilar",
    image: GALLERY_URLS.img8158,
    alt: "Shampoo preventivo con miel, romero y neem",
    note: "Producto nuevo",
  },
  {
    id: "img-8159",
    name: "Shampoo mascarilla · presentación",
    category: "Cuidado capilar",
    image: GALLERY_URLS.img8159,
    alt: "Shampoo mascarilla de miel, romero y canela",
    note: "Producto identificado",
  },
  {
    id: "img-8160",
    name: "Shampoo mascarilla · reverso",
    category: "Cuidado capilar",
    image: GALLERY_URLS.img8160,
    alt: "Vista posterior del shampoo mascarilla",
    note: "Vista complementaria",
  },
  {
    id: "img-8161",
    name: "Shampoo mascarilla · frente",
    category: "Cuidado capilar",
    image: GALLERY_URLS.img8161,
    alt: "Vista frontal del shampoo mascarilla",
    note: "Vista complementaria",
  },
  {
    id: "img-8162",
    name: "Repelente de neem · vista",
    category: "Protección natural",
    image: GALLERY_URLS.img8162,
    alt: "Vista alternativa del repelente de neem",
    note: "Vista complementaria",
  },
  {
    id: "img-8163",
  ...
  },
  {
    ...
    category: "Mieles y elixires",
    image: GALLERY_URLS.img8167,
    alt: "Frasco abierto con mezcla apícola y cuchara",
    note: "Producto por identificar",
  },
  {
    id: "img-8169",
    name: "Hidromiel de la Selva",
    category: "Mieles y elixires",
    image: GALLERY_URLS.img8169,
    alt: "Botella de Hidromiel de la Selva",
    note: "Producto nuevo",
  },
  {
    id: "img-8173",
    ...
    alt: "Frasco de miel de abejas meliponas con tapa dorada",
    note: "Producto identificado",
  },
  {
    id: "bee-soap",
    name: "Jabón diseño abeja",
    category: "Jabones artesanales",
    image: GALLERY_URLS.beeSoap,
    alt: "Jabón artesanal con diseño de abeja y panal",
    note: "Producto identificado",
  },
  {
    id: "turmeric-soap",
  ...
  {
    id: "neem-honey-soap",
    name: "Jabón de neem y miel",
    category: "Jabones artesanales",
    image: GALLERY_URLS.neemHoneySoap,
    alt: "Jabón artesanal de neem y miel",
    note: "Producto identificado",
  },
];
    ...
    <main className="page-shell">
      ...
      >
        ...
        <div className="gallery-meta">
          ...
          <span className="gallery-meta-note">26 imágenes publicadas</span>
        </div>
